...
/*
void hitsDialog::buildTable( std::vector< std::pair<QString, float> > &hitVec, std::set<QString> &actives, std::set<QString> &act_and_test )
{
   //cout <<"You are in buildTable" << endl;
   table1->insertRows(0, hitVec.size() );
