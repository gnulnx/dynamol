...
testmodel4::testmodel4()
    : QMainWindow( 0, "testmodel4", WDestructiveClose )
{
...
void testmodel4::newDoc()
{
    testmodel4 *ed = new testmodel4;
    ed->setCaption(tr("Qt Example - Application"));
    ed->show();
}

void testmodel4::choose()
{
...
void testmodel4::load( const QString &fileName )
{
    QFile f( fileName );
...
void testmodel4::closeEvent( QCloseEvent* ce )
{
    if ( !e->isModified() ) {
	ce->accept();
	return;
